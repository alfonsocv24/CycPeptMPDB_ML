...
loss_per_fold = []
# Load mutations
with open('mut_dict_Final.pkl', 'rb') as f:
...
for train, test in kfold.split(X, y):
    ...
    file_length = f'{dataset}_CM_split_lengths.dat'
    file_acc = f'Accuracy_CM_{dataset}.dat'
    file_metric = f'Metrics_CM_{dataset}.dat'
    if args.Trained:
